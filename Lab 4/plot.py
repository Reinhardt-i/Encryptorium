...
def plot_execution_times(aes_enc_times, aes_dec_times, rsa_enc_times, rsa_dec_times):
    aes_key_sizes_bytes = [16, 32, 64, 128, 256]  # Corresponding to key sizes in bits
    rsa_key_sizes_bits = [512, 1024, 2048, 4096]

    plt.figure(figsize=(10, 5))
    plt.subplot(1, 2, 1)
    plt.plot(aes_key_sizes_bytes, aes_enc_times, marker='o', linestyle='-', color='b', label='AES Encryption')
    plt.plot(aes_key_sizes_bytes, aes_dec_times, marker='o', linestyle='-', color='r', label='AES Decryption')
    ...
    plt.subplot(1, 2, 2)
    plt.plot(rsa_key_sizes_bits, rsa_enc_times, marker='o', linestyle='-', color='b', label='RSA Encryption')
    plt.plot(rsa_key_sizes_bits, rsa_dec_times, marker='o', linestyle='-', color='r', label='RSA Decryption')
...
def main():
    ...
    plot_execution_times(aes_enc_times, aes_dec_times, rsa_enc_times, rsa_dec_times)
